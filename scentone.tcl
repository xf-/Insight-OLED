...
add_de1_page "scentone_1" "scentone_1.jpg" "Insight-OLED"
add_de1_page "scentone_tropical" "scentone_tropical.jpg" "Insight-OLED"
add_de1_page "scentone_berry" "scentone_berry.jpg" "Insight-OLED"
add_de1_page "scentone_citrus" "scentone_citrus.jpg" "Insight-OLED"
add_de1_page "scentone_stone" "scentone_stone.jpg" "Insight-OLED"
add_de1_page "scentone_cereal" "scentone_cereal.jpg" "Insight-OLED"
add_de1_page "scentone_chocolate" "scentone_chocolate.jpg" "Insight-OLED"
add_de1_page "scentone_flower" "scentone_flower.jpg" "Insight-OLED"
add_de1_page "scentone_spice" "scentone_spice.jpg" "Insight-OLED"
add_de1_page "scentone_vegetable" "scentone_vegetable.jpg" "Insight-OLED"
add_de1_page "scentone_savory" "scentone_savory.jpg" "Insight-OLED"

add_de1_page "describe_espresso" "describe_espresso.jpg" "Insight-OLED"
add_de1_page "describe_espresso2" "describe_espresso2.jpg" "Insight-OLED"
add_de1_page "describe_espresso0" "describe_espresso0.jpg" "Insight-OLED"
...
add_de1_widget "describe_espresso0" entry 70 1282  {
	...
	} -width [expr {int(45 * $::globals(entry_length_multiplier))}] -font Helv_8  -borderwidth 1 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(god_espresso_name)
...
} -background #000000 -yscrollcommand {scale_scroll ::gotshots_slider} -font $listbox_font -bd 0 -height $godshots_listbox_height -width 33 -foreground #d3dbf3 -borderwidth 0 -selectborderwidth 0  -relief flat -highlightthickness 0 -selectmode single  -selectbackground #c0c4e1
...
set slider_trough_color1 #222222
set slider_trough_color2 #000000
...
add_de1_text "describe_espresso" 80 360 -text [translate "Enjoyment"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" -width 800 -justify "left"
	...
	add_de1_variable "describe_espresso" 1300 600 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {$::settings(espresso_enjoyment)}
...
#	add_de1_variable "describe_espresso" 760 980 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_off_if_zero $::settings(espresso_sweetness)]}
...
#	add_de1_variable "describe_espresso" 760 1210 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_off_if_zero $::settings(espresso_acidity)]}
...
#	add_de1_variable "describe_espresso" 1500 980 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_off_if_zero $::settings(espresso_aftertaste)]}
	...
	add_de1_widget "describe_espresso" multiline_entry 80 820 {
			bind $widget <Leave> hide_android_keyboard
	} -width 50 -height 8 -font Helv_8  -borderwidth 2 -bg #000000  -foreground #dddddd -textvariable ::settings(espresso_notes) -relief flat -highlightthickness 1 -highlightcolor #000000
...
add_de1_text "describe_espresso2" 80 360 -text [translate "Grinder"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" -width 800 -justify "left"
	...
	add_de1_widget "describe_espresso2" entry 550 430 {
			bind $widget <Leave> hide_android_keyboard
	} -width [expr {int(28 * $::globals(entry_length_multiplier))}] -font Helv_8 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(grinder_model)
	...
	add_de1_widget "describe_espresso2" entry 550 520 {
		bind $widget <Leave> hide_android_keyboard
	} -width [expr {int(28 * $::globals(entry_length_multiplier))}] -font Helv_8 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(grinder_setting)

	#set slider_trough_color2 #080808
	...
	add_de1_variable "describe_espresso2" 1160 760 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_stop_at_weight_measurement_precise $::settings(grinder_dose_weight)]}
...
add_de1_text "describe_espresso2" 80 790 -text [translate "Beans"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" -width 800 -justify "left"
	...
	add_de1_widget "describe_espresso2" entry 550 850 {
		bind $widget <Leave> hide_android_keyboard
	} -width [expr {int(28 * $::globals(entry_length_multiplier))}] -font Helv_8 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(bean_brand)
	...
	add_de1_widget "describe_espresso2" entry 550 930 {
		bind $widget <Leave> hide_android_keyboard
	} -width [expr {int(28 * $::globals(entry_length_multiplier))}] -font Helv_8 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(bean_type)
	...
	add_de1_widget "describe_espresso2" entry 550 1010 {
		bind $widget <Leave> hide_android_keyboard
	} -width [expr {int(28 * $::globals(entry_length_multiplier))}] -font Helv_8 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(roast_date)
	...
	add_de1_widget "describe_espresso2" entry 550 1090 {
		bind $widget <Leave> hide_android_keyboard
	} -width [expr {int(28 * $::globals(entry_length_multiplier))}] -font Helv_8 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(roast_level)
	...
	add_de1_widget "describe_espresso2" multiline_entry 550 1180 {
		bind $widget <Leave> hide_android_keyboard
	} -width [expr {int(22 * $::globals(entry_length_multiplier))}] -height 3 -font Helv_8  -borderwidth 2 -bg #000000  -foreground #dddddd -textvariable ::settings(bean_notes) -relief flat -highlightthickness 1 -highlightcolor #000000
	...
	add_de1_widget "describe_espresso2" entry 1340 430 {
		bind $widget <Leave> hide_android_keyboard
	} -width 40 -font Helv_8 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(my_name)
...
add_de1_text "describe_espresso2" 1340 560 -text [translate "Enable these features"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" -width 800 -justify "left"
	add_de1_widget "describe_espresso2" checkbutton 1360 630 { } -command {} -padx 0 -pady 0 -bg #FFFFFF -text [translate "I weigh my drinks"] -indicatoron true -font Helv_8  -anchor nw -foreground #dddddd -activeforeground #dddddd -variable ::settings(has_scale)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF
	add_de1_widget "describe_espresso2" checkbutton 1360 690 { } -command {} -padx 0 -pady 0 -bg #FFFFFF -text [translate "I use a refractometer"] -indicatoron true -font Helv_8  -anchor nw -foreground #dddddd -activeforeground #dddddd -variable ::settings(has_refractometer)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF
...
if {$::settings(has_refractometer) == 1 || $::settings(has_scale) == 1} {
	...
	add_de1_widget "describe_espresso" scale 1630 500 {} -to 100 -from 0 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 10 -resolution 0.1 -length [rescale_x_skin 850]  -width [rescale_y_skin 140] -variable ::settings(drink_weight) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color2 -borderwidth 0  -highlightthickness 0 -orient horizontal 
	add_de1_variable "describe_espresso" 2480 640 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_shot_weight_measurement $::settings(drink_weight)]}
	#add_de1_variable "describe_espresso" 2480 640 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {$::settings(drink_weight)}
	...
	if {$::settings(has_refractometer) == 1} {
		...
		add_de1_variable "describe_espresso" 2480 870 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_percent_off_if_zero $::settings(drink_tds)]}
		...
		add_de1_widget "describe_espresso" scale 1630 960 {} -to 30 -from 0 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 10 -resolution 0.1 -length [rescale_x_skin 850]  -width [rescale_y_skin 140] -variable ::settings(drink_ey) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color2 -borderwidth 0  -highlightthickness 0 -orient horizontal 
		add_de1_variable "describe_espresso" 2480 1100 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_percent_off_if_zero $::settings(drink_ey)]}
	}
