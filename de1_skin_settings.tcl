...
add_de1_page "settings_1" "settings_1.png" "Insight-OLED"

#add_de1_page "settings_2a" "settings_2a.png" "Insight-OLED"
#add_de1_page "settings_2b" "settings_2b.png" "Insight-OLED"
#if {$::settings(scale_bluetooth_address) == ""} {
#} else {
	add_de1_page "settings_2a" "settings_2a2.png" "Insight-OLED"
	add_de1_page "settings_2b" "settings_2b2.png" "Insight-OLED"
#}
add_de1_page "settings_2c" "settings_2c.png" "Insight-OLED"
add_de1_page "settings_2c2" "settings_2c2.png" "Insight-OLED"
add_de1_page "settings_2czoom" "settings_2c.png" "Insight-OLED"
...
add_de1_page "settings_3" "settings_3.png" "Insight-OLED"
add_de1_page "settings_4" "settings_4.png" "Insight-OLED"
...
set ::message_label [add_de1_text "message" 1280 800 -text "" -font Helv_15_bold -fill "#ffffff" -justify "center" -anchor "center" -width 900]
...
set ::infopage_label [add_de1_text "infopage" 1280 800 -text "" -font Helv_10_bold -fill "#ffffff" -justify "center" -anchor "center" -width 900]
...
set slider_trough_color #333333
set chart_background_color #000000
##############################################################################################################################################################################################################################################################################
...
# preinfusing
add_de1_text "settings_2a settings_2b" 45 755 -text [translate "1: preinfuse"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 600 -justify "left" 
	...
	set ::preinfusion_pressure_widget_label [add_de1_variable "settings_2a" 820 1325 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {< $::settings(preinfusion_stop_pressure) [translate bar]}]
	...
	set ::preinfusion_flow_widget_label [add_de1_variable "settings_2b" 820 1325 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_flow_measurement $::settings(preinfusion_flow_rate)]}]
	...
	set ::preinfusion_flow_pressure_widget_label [add_de1_variable "settings_2b" 47 1265 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {< $::settings(preinfusion_stop_pressure) [translate bar]}]
	...
	set ::preinfusion_pressure_flow_widget_label [add_de1_variable "settings_2a" 47 1325 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {[return_flow_measurement $::settings(preinfusion_flow_rate)]}]

add_de1_text "settings_2a" 890 755 -text [translate "2: rise and hold"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 600 -justify "left" 
	...
	add_de1_variable "settings_2 settings_2a" 1192 1030 -text "" -font Helv_8 -fill "#dddddd" -anchor "center" -width 600 -justify "left" -textvariable {[canvas_hide_if_zero $::settings(espresso_hold_time) [list $::espresso_pressure_widget $::espresso_pressure_widget_label]; seconds_text $::settings(espresso_hold_time)]}
	...
	set ::espresso_pressure_widget_label [add_de1_variable "settings_2 settings_2a" 1667 1325 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_pressure_measurement $::settings(espresso_pressure)]}]
...
add_de1_text "settings_2 settings_2a" 1730 755 -text [translate "4: decline"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 600 -justify "left"
	...
	add_de1_variable "settings_2 settings_2a" 1735 1000 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {[canvas_hide_if_zero $::settings(espresso_decline_time) [list $::espresso_pressure_decline_widget $::espresso_pressure_decline_widget_label]; seconds_text $::settings(espresso_decline_time)]}
	...
	set ::espresso_pressure_decline_widget_label [add_de1_variable "settings_2 settings_2a" 2510 1325 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_pressure_measurement $::settings(pressure_end)]}]
...
add_de1_button "settings_2a settings_2b" {say [translate {temperature}] $::settings(sound_button_in); change_espresso_temperature 0.5; profile_has_changed_set } 2404 192 2590 320
	...
	add_de1_variable "settings_2a settings_2b" 2470 600 -text "" -font Helv_8 -fill "#dddddd" -anchor "center" -textvariable {[round_and_return_temperature_setting ::settings(espresso_temperature)]}
	add_de1_variable "settings_2a settings_2b" 820 760 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -textvariable {[if {[ifexists ::settings(espresso_temperature_steps_enabled)] == 1} { return [subst {[round_and_return_step_temperature_setting ::settings(espresso_temperature_0)] / [round_and_return_step_temperature_setting ::settings(espresso_temperature_1)]}]} else {return ""}]}
	...
	#add_de1_variable "settings_2a settings_2b" 744 790 -text "" -font Helv_8 -fill "#dddddd" -anchor "center" -textvariable {[round_and_return_step_temperature_setting ::settings(espresso_temperature_1)]}
	add_de1_variable "settings_2a settings_2b" 1666 760 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -textvariable {[round_and_return_step_temperature_setting ::settings(espresso_temperature_2)]}
	add_de1_variable "settings_2a settings_2b" 2510 760 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -textvariable {[round_and_return_step_temperature_setting ::settings(espresso_temperature_3)]}
...
add_de1_text "temperature_steps" 1280 290 -text [translate "Temperature Steps"] -font Helv_20_bold -width 1200 -fill "#444444" -anchor "center" -justify "center" 
	...
	add_de1_variable "temperature_steps" 1800 500 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -textvariable {[round_and_return_step_temperature_setting ::settings(espresso_temperature_0)]}
	add_de1_variable "temperature_steps" 1800 680 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -textvariable {[round_and_return_step_temperature_setting ::settings(espresso_temperature_1)]}
	add_de1_variable "temperature_steps" 1800 860 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -textvariable {[round_and_return_step_temperature_setting ::settings(espresso_temperature_2)]}
	add_de1_variable "temperature_steps" 1800 1040 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -textvariable {[round_and_return_step_temperature_setting ::settings(espresso_temperature_3)]}
...
add_de1_text "settings_2b" 890 755 -text [translate "2: hold"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 600 -justify "left" 
	...
	add_de1_variable "settings_2b" 892 1000 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {[canvas_hide_if_zero $::settings(espresso_hold_time) [list $::flow_hold_widget $::flow_hold_widget_label]; seconds_text $::settings(espresso_hold_time)]}
	...
	set ::flow_hold_widget_label [add_de1_variable "settings_2b" 1667 1325 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_flow_measurement $::settings(flow_profile_hold)]}]
...
add_de1_text "settings_2b" 1730 755 -text [translate "3: decline"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 600 -justify "left" 
	...
	add_de1_variable "settings_2b" 1735 1000 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {[canvas_hide_if_zero $::settings(espresso_decline_time) [list $::flow_decline_widget $::flow_decline_widget_label]; seconds_text $::settings(espresso_decline_time)]}
	...
	set ::flow_decline_widget_label [add_de1_variable "settings_2b" 2510 1325 -text "" -font Helv_8 -fill "#dddddd" -anchor "ne" -width 600 -justify "left" -textvariable {[return_flow_measurement $::settings(flow_profile_decline)]}]
...
} -plotbackground $chart_background_color -width [rescale_x_skin 2375] -height [rescale_y_skin 500] -borderwidth 1 -background #000000 -plotrelief raised -plotpady 0 -plotpadx 10

############################

# preheat tank temperature
add_de1_text "settings_2c2" 70 230 -text [translate "Preheat water tank"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 800 -justify "center"
	...
	add_de1_variable "settings_2c2" 70 450 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {[return_temperature_setting_or_off $::settings(tank_desired_water_temperature)]}

# total water volume stopping of shots
add_de1_text "settings_2c2" 70 530 -text [translate "Stop at water volume"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 800 -justify "center"
	...
	add_de1_variable "settings_2c2" 70 750 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {[return_stop_at_volume_measurement $::settings(final_desired_shot_volume_advanced)]}
	
	add_de1_text "settings_2c2" 1670 530 -text [translate "Track water volume"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 800 -justify "center"
	...
	add_de1_variable "settings_2c2" 1670 750 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {[when_to_start_pour_tracking_advanced]}
...
if {$::settings(scale_bluetooth_address) != ""} {
	...
	add_de1_text "settings_2a settings_2b" 1730 1100 -text [translate "4: stop at pour:"] -font Helv_10_bold -fill "#777777" -anchor "nw" -width 800 -justify "center"
	add_de1_widget "settings_2a settings_2b" scale 1730 1175 {} -to 160 -from -60 -background #004400 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 1 -length [rescale_x_skin 546]  -width [rescale_y_skin 150] -variable ::settings(final_desired_shot_volume) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command "range_check_shot_variables; profile_has_changed_set; update_de1_explanation_chart_soon" -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal
	add_de1_variable "settings_2a settings_2b" 1730 1325 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 600 -justify "left" -textvariable {[return_stop_at_volume_measurement $::settings(final_desired_shot_volume)]}
}


add_de1_text "settings_2c settings_2c2 settings_2czoom" 240 1485 -text [translate "Steps"] -font Helv_10_bold -fill "#777777" -anchor "center" 
add_de1_text "settings_2c settings_2c2 settings_2czoom" 735 1485 -text [translate "Limits"] -font Helv_10_bold -fill "#777777" -anchor "center" 
...
add_de1_widget "settings_2 settings_2a" graph 24 220 { 
	update_de1_explanation_chart;
	$widget element create line_espresso_de1_explanation_chart_pressure -xdata espresso_de1_explanation_chart_elapsed -ydata espresso_de1_explanation_chart_pressure -symbol circle -label "" -linewidth [rescale_x_skin 5] -color #008c4c  -smooth $::settings(profile_graph_smoothing_technique) -pixels [rescale_x_skin 30];
	$widget axis configure x -color #5a5d75 -tickfont Helv_6 -command graph_seconds_axis_format; 
	$widget axis configure y -color #5a5d75 -tickfont Helv_6 -min 0.0 -max [expr {0.1 + $::de1(maxpressure)}] -stepsize 2 -majorticks {1 3 5 7 9 11} -title [translate "pressure (bar)"] -titlefont Helv_10 -titlecolor #e1e1e1;
...
add_de1_text "settings_2c" 70 230 -text [translate "Steps"] -font Helv_10_bold -fill "#777777" -anchor "nw" 

add_de1_text "settings_2c" 984 240 -text [translate "1: Temperature"] -font Helv_9_bold -fill "#777777" -anchor "nw" 
...
add_de1_text "settings_2c" 984 830 -text [translate "3: Maximum"] -font Helv_9_bold -fill "#777777" -anchor "nw"

#add_de1_variable "settings_2c" 2238 830 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable {$::settings(settings_profile_type)}


add_de1_widget "settings_2c" checkbutton 1538 830 {} -text [translate "4: Move on if..."] -padx 0 -pady 0 -indicatoron true  -font Helv_9_bold -anchor nw -foreground #777777 -activeforeground #777777 -variable ::current_adv_step(exit_if)  -borderwidth 0  -highlightthickness 0  -command save_current_adv_shot_step -selectcolor #f9f9f9 -activebackground #f9f9f9 -bg #f9f9f9 -relief flat 
...
} -background #000000 -yscrollcommand {scale_scroll_new $::advanced_shot_steps_widget ::advsteps_slider} -xscrollcommand {scale_prevent_horiz_scroll $::advanced_shot_steps_widget} -font $listbox_font -bd 0 -height $adv_listbox_height -width 18 -foreground #555555 -borderwidth 0 -selectborderwidth 0  -relief flat -highlightthickness 0 -selectmode single  -selectbackground #c0c4e1
...
set ::advsteps_scrollbar [add_de1_widget "settings_2c" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#555555" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_y_skin 150] -variable ::advsteps_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::advanced_shot_steps_widget $::advsteps_slider}  -foreground #FFFFFF -troughcolor "#333333" -borderwidth 0  -highlightthickness 0]
...
#add_de1_text "settings_2c" 70 742 -text [translate "Insert a step"] -font Helv_9_bold -fill "#777777" -justify "left" -anchor "nw" 
add_de1_widget "settings_2c" entry 70 822  {
	...
	} -width [expr {int(27 * $::globals(entry_length_multiplier))}] -font Helv_8  -borderwidth 1 -bg #FFFFFF  -foreground #dddddd -textvariable ::profile_step_name_to_add
...
add_de1_text "settings_2c" 1070 680 -text [translate "goal"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
	add_de1_variable "settings_2c" 1070 744 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable {[return_temperature_setting [ifexists ::current_adv_step(temperature)]]}
...
add_de1_text "settings_2c" 1380 680 -text [translate "sensor"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
	...
	add_de1_variable "settings_2c" 1380 744 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable {[translate [ifexists ::current_adv_step(sensor)]]}
...
add_de1_text "settings_2c" 2345 680 -text [translate "transition"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center"
	...
	add_de1_variable "settings_2c" 2345 744 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable {[translate [ifexists ::current_adv_step(transition)]]}


add_de1_text "settings_2c" 1090 1270 -text [translate "time"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center"
	...
	add_de1_variable "settings_2c" 1090 1340 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable {[seconds_text [round_to_integer [ifexists ::current_adv_step(seconds)]]]}


#add_de1_text "settings_2c" 1360 1270 -text [translate "volume"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
...
#	add_de1_variable "settings_2c" 1360 1340 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable {[return_liquid_measurement [ifexists ::current_adv_step(volume)]]}


add_de1_text "settings_2c" 1654 1240 -text [translate "pressure"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
add_de1_text "settings_2c" 1654 1270 -text [translate "is over"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
	add_de1_variable "settings_2c" 1654 1340 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable { [ if {[ifexists ::current_adv_step(exit_if)] == 1 && [ifexists ::current_adv_step(exit_type)] == "pressure_over"} { return_pressure_measurement [ifexists ::current_adv_step(exit_pressure_over) 11] } else  { return "-" } ] }
...
add_de1_text "settings_2c" 1890 1240 -text [translate "pressure"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
add_de1_text "settings_2c" 1890 1270 -text [translate "is under"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
	add_de1_variable "settings_2c" 1890 1340 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable { [ if {[ifexists ::current_adv_step(exit_if)] == 1 && [ifexists ::current_adv_step(exit_type)] == "pressure_under"} { return_pressure_measurement [ifexists ::current_adv_step(exit_pressure_under) 0] } else  { return "-" } ] }
...
add_de1_text "settings_2c" 2144 1240 -text [translate "flow"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
add_de1_text "settings_2c" 2144 1270 -text [translate "is over"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
	add_de1_variable "settings_2c" 2144 1340 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable { [ if {[ifexists ::current_adv_step(exit_if)] == 1 && [ifexists ::current_adv_step(exit_type)] == "flow_over"} { return_flow_measurement [ifexists ::current_adv_step(exit_flow_over) 6]} else  { return "-" } ] }
...
add_de1_text "settings_2c" 2394 1240 -text [translate "flow"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
add_de1_text "settings_2c" 2394 1270 -text [translate "is under"] -font Helv_6 -fill "#777777" -anchor "center" -width 400 -justify "center" 
	add_de1_variable "settings_2c" 2394 1340 -text "" -font Helv_7_bold -fill "#dddddd" -anchor "center" -textvariable { [ if {[ifexists ::current_adv_step(exit_if)] == 1 && [ifexists ::current_adv_step(exit_type)] == "flow_under"} { return_flow_measurement [ifexists ::current_adv_step(exit_flow_under) 0] } else  { return "-" } ] }
...
add_de1_widget "settings_1" listbox 50 305 { 
	...
	} -background #000000 -xscrollcommand {scale_prevent_horiz_scroll $::globals(profiles_listbox)} -yscrollcommand {scale_scroll_new $::globals(profiles_listbox) ::profiles_slider} -font $listbox_font -bd 0 -height $profiles_listbox_length -width 32 -foreground #555555 -borderwidth 0 -selectborderwidth 0  -relief flat -highlightthickness 0 -selectmode single  -selectbackground #c0c4e1 

set ::profiles_slider 0

# draw the scrollbar off screen so that it gets resized and moved to the right place on the first draw
set ::profiles_scrollbar [add_de1_widget "settings_1" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#555555" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_y_skin 150] -variable ::profiles_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::globals(profiles_listbox) $::profiles_slider}  -foreground #FFFFFF -troughcolor "#333333" -borderwidth 0  -highlightthickness 0]
...
# add_de1_widget "settings_1" checkbutton 50 1310 {} -text [translate "Also load God Shot"] -indicatoron true  -font Helv_8 -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::settings(also_load_god_shot)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF  -bd 0 -activeforeground #dddddd -relief flat -bd 0
...
add_de1_widget "settings_1" graph 1330 300 { 
		...
		$::preview_graph_pressure axis configure y -color #5a5d75 -tickfont Helv_6 -min 0.0 -max 11.5 -stepsize 2 -majorticks {1 3 5 7 9 11} -title [translate "pressure (bar)"] -titlefont Helv_8 -titlecolor #e1e1e1;
	...
	} -plotbackground $chart_background_color -width [rescale_x_skin 1050] -height [rescale_y_skin 450] -borderwidth 1 -background #000000 -plotrelief raised -plotpady 0 -plotpadx 10
...
add_de1_widget "settings_1c" graph 1330 300 { 
		...
		#$::preview_graph_pressure element create line_espresso_de1_explanation_chart_pressure_adv -xdata espresso_de1_explanation_chart_elapsed -ydata espresso_de1_explanation_chart_pressure -symbol circle -label "" -linewidth [rescale_x_skin 10] -color #dddddd  -smooth $::settings(profile_graph_smoothing_technique) -pixels [rescale_x_skin 20];
		...
		#$::preview_graph_advanced element create line_espresso_de1_explanation_chart_adv -xdata espresso_de1_explanation_chart_elapsed_flow -ydata espresso_de1_explanation_chart_flow -symbol circle -label "" -linewidth [rescale_x_skin 10] -color #dddddd  -smooth $::settings(profile_graph_smoothing_technique)$::settings(profile_graph_smoothing_technique) -pixels [rescale_x_skin 30];
...
add_de1_widget "settings_2c" graph 8 960 { 
	...
	} -plotbackground $chart_background_color -width [rescale_x_skin 920] -height [rescale_y_skin 450] -borderwidth 1 -background #111111 -plotrelief raised  -plotpady 0 -plotpadx 10
...
add_de1_widget "settings_2czoom" graph 8 200 { 
	...
	} -plotbackground $chart_background_color -width [rescale_x_skin 2540] -height [rescale_y_skin 1220] -borderwidth 1 -background #111111 -plotrelief raised  -plotpady 0 -plotpadx 10
...
add_de1_variable "settings_1" 2466 660 -text "" -font Helv_7 -fill "#777777" -anchor "center" -textvariable {[return_temperature_setting $::settings(espresso_temperature)]}


add_de1_text "settings_3" 1304 220 -text [translate "Maintenance"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
...
add_de1_text "settings_3" 1304 750 -text [translate "Firmware"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
	# firmware update
...
# app update
add_de1_text "settings_4" 50 220 -text [translate "Update App"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
...
# buttons to other settings pages
	add_de1_text "settings_4" 1656 416 -text [translate "Skin"] -font Helv_10_bold -fill "#FFFFFF" -anchor "center" 
		...
		add_de1_widget "tabletstyles" listbox 260 450 { 
			...
			} -background #000000 -xscrollcommand {scale_prevent_horiz_scroll $::globals(tablet_styles_listbox)} -yscrollcommand {scale_scroll_new $::globals(tablet_styles_listbox) ::skin_slider} -font global_font -bd 0 -height $tabletstyles_listbox_length -width 30 -foreground #555555 -borderwidth 0 -selectborderwidth 0  -relief flat -highlightthickness 0 -selectmode single -selectbackground #c0c4e1

		set ::skin_slider 0
		set ::skin_scrollbar [add_de1_widget "tabletstyles" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#555555" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_y_skin 150] -variable ::skin_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::globals(tablet_styles_listbox) $::skin_slider}  -foreground #FFFFFF -troughcolor "#333333" -borderwidth 0  -highlightthickness 0]
	...
	add_de1_text "settings_4" 2290 416 -text [translate "Language"] -font Helv_10_bold -fill "#FFFFFF" -anchor "center" 
		...
		} -background #000000 -xscrollcommand {scale_prevent_horiz_scroll $::languages_widget} -yscrollcommand {scale_scroll_new $::languages_widget ::language_slider} -font global_font -bd 0 -height [expr {int(9 * $::globals(listbox_length_multiplier))}] -width 26 -foreground #555555 -borderwidth 0 -selectborderwidth 0  -relief flat -highlightthickness 0 -selectmode single  -selectbackground #c0c4e1


		set ::language_slider 0
		set ::languages_scrollbar [add_de1_widget "languages" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#555555" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_y_skin 150] -variable ::language_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::languages_widget $::language_slider}  -foreground #FFFFFF -troughcolor "#333333" -borderwidth 0  -highlightthickness 0]
	...
	add_de1_text "settings_4" 1656 616 -text [translate "Misc"] -font Helv_10_bold -fill "#ffffff" -anchor "center"
		...
		add_de1_text "measurements" 1300 480 -text [translate "Units"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
			add_de1_widget "measurements" checkbutton 1300 560 {} -text [translate "Fahrenheit"] -indicatoron true  -font $optionfont -bg #000000 -anchor nw -foreground #dddddd -variable ::settings(enable_fahrenheit)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000  -bd 0 -activeforeground #dddddd -relief flat -bd 0
			add_de1_widget "measurements" checkbutton 1650 560 {} -text [translate "AM/PM"] -indicatoron true  -font $optionfont -bg #000000 -anchor nw -foreground #dddddd -variable ::settings(enable_ampm)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000 -bd 0 -activeforeground #dddddd  -relief flat
			add_de1_widget "measurements" checkbutton 2000 560 {} -text [translate "1.234,56"] -indicatoron true  -font $optionfont -bg #000000 -anchor nw -foreground #dddddd -variable ::settings(enable_commanumbers)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000 -bd 0 -activeforeground #dddddd  -relief flat

		#if {$::settings(display_fluid_ounces_option) == 1} {
		#	add_de1_widget "measurements" checkbutton 690 1000 {} -text [translate "Fluid ounces"] -indicatoron true  -font Helv_9 -bg #000000 -anchor nw -foreground #dddddd -variable ::settings(enable_fluid_ounces)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000 -bd 0 -activeforeground #dddddd -relief flat
		#}

		add_de1_text "measurements" 1300 660 -text [translate "Optional features"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"

			if {[ifexists ::settings(skin)] == "Insight" && [ghc_required] != 1} {
				# this feature is specific to the Insight skin
				add_de1_widget "measurements" checkbutton 1800 740 {} -text [translate "One-tap mode"] -indicatoron true  -font $optionfont -bg #000000 -anchor nw -foreground #dddddd -variable ::settings(one_tap_mode)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000 -bd 0 -activeforeground #dddddd  -relief flat
			}
			...
			if {[ghc_required] == 0} {
				...
				add_de1_widget "measurements" checkbutton 1800 800  {} -text [translate "Repeat last command"] -indicatoron true  -font $optionfont -bg #000000 -anchor nw -foreground #dddddd -variable ::settings(stress_test)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000 -bd 0 -activeforeground #dddddd  -relief flat
			}

			add_de1_widget "measurements" checkbutton 1300 740  {} -text [translate "Make a log file"] -indicatoron true  -font $optionfont -bg #000000 -anchor nw -foreground #dddddd -variable ::settings(log_enabled)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000 -bd 0 -activeforeground #dddddd  -relief flat
			add_de1_widget "measurements" checkbutton 950 490  {} -text [translate "clock"] -indicatoron true  -font $optionfont -bg #000000 -anchor ne -foreground #dddddd -variable ::settings(display_time_in_screen_saver)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000 -bd 0 -activeforeground #dddddd  -relief flat
		...
		add_de1_text "measurements" 1300 900 -text [translate "Font size"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
			...
			add_de1_variable "measurements" 1300 1060 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 800 -justify "left" -textvariable {$::settings(default_font_calibration)}


		add_de1_text "measurements" 340 480 -text [translate "Screen saver"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
			...
			add_de1_variable "measurements" 340 660 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 800 -justify "left" -textvariable {[translate "Brightness"] $::settings(saver_brightness)%}
			...
			add_de1_variable "measurements" 340 840 -text "" -font Helv_8 -fill "#dddddd" -anchor "nw" -width 800 -justify "left" -textvariable {[screen_saver_change_minutes $::settings(screen_saver_change_interval)]}

			add_de1_text "measurements" 340 940 -text [translate "App version"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
				add_de1_widget "measurements" radiobutton 340 1010  {} -value 0 -text [translate "stable"] -indicatoron true  -font $optionfont -bg #000000 -anchor ne -foreground #777777 -variable ::settings(app_updates_beta_enabled)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #4e85f4  -relief flat
				add_de1_widget "measurements" radiobutton 600 1010  {} -value 1 -text [translate "beta"] -indicatoron true  -font $optionfont -bg #000000 -anchor ne -foreground #777777 -variable ::settings(app_updates_beta_enabled)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #4e85f4  -relief flat
				add_de1_widget "measurements" radiobutton 860 1010  {} -value 2 -text [translate "nightly"] -indicatoron true  -font $optionfont -bg #000000 -anchor ne -foreground #777777 -variable ::settings(app_updates_beta_enabled)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #4e85f4  -relief flat
...
# grid [radiobutton .gender.femaleBtn -text "Female" -variable gender -value "Female"   -command "set  myLabel1 Female"] -row 1 -column 3				
				...
				#add_de1_variable "measurements" 340 1110 -text "" -font Helv_7 -fill "#dddddd" -anchor "nw" -width 800 -justify "left" -textvariable {[translate "Once stable for:"] [days_text $::settings(app_update_delay_notification)]}
...
# exit app feature
add_de1_text "settings_4" 1310 1130 -text [translate "Exit app"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
...
add_de1_text "settings_3" 55 544 -text [translate {Version}] -font Helv_10_bold -fill "#777777" -anchor "nw" -width [rescale_y_skin 1220] -justify "left" 
	add_de1_variable "settings_3" 55 616 -text "" -font Helv_7 -fill "#777777" -anchor "nw" -width [rescale_y_skin 1180] -justify "left" -textvariable {[de1_version_string]} 

#add_de1_text "settings_3" 1310 380 -text [translate "Water level"] -font Helv_7_bold -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "left" 
#	add_de1_variable "settings_3" 1600 380 -text "" -font Helv_7 -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "left" -textvariable {[round_to_integer $::de1(water_level)][translate mm]}

	#add_de1_text "settings_3" 1310 350 -text [translate "Counter"] -font Helv_7_bold -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "left"

	add_de1_text "settings_3" 55 220 -text [translate "Counter"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
		add_de1_text "settings_3" 55 310 -text [translate "Espresso"] -font Helv_8 -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "left" 
		add_de1_text "settings_3" 55 370 -text [translate "Steam"] -font Helv_8 -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "left"
		add_de1_text "settings_3" 55 430 -text [translate "Hot water"] -font Helv_8 -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "left"
		add_de1_variable "settings_3" 400 310 -text "" -font Helv_8 -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "right" -textvariable {[round_to_integer $::settings(espresso_count)]}
		add_de1_variable "settings_3" 400 370 -text "" -font Helv_8 -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "right" -textvariable {[round_to_integer $::settings(steaming_count)]}
		add_de1_variable "settings_3" 400 430 -text "" -font Helv_8 -fill "#777777" -anchor "nw" -width [rescale_y_skin 1000] -justify "right" -textvariable {[round_to_integer $::settings(water_count)]}
...
add_de1_widget "settings_3" checkbutton 50 1140 {} -text [translate "Scheduler"] -padx 0 -pady 0 -indicatoron true  -font Helv_8_bold -bg #000000 -anchor nw -foreground #777777 -activeforeground #777777 -variable ::settings(scheduler_enable)  -borderwidth 0 -selectcolor #000000 -highlightthickness 0 -activebackground #000000 -command scheduler_feature_hide_show_refresh -relief flat
	...
	set scheduler_widget_id2 [add_de1_variable "settings_3" 50 1340 -text "" -font Helv_7 -fill "#dddddd" -anchor "nw" -textvariable {[translate "Heat up:"] [format_alarm_time $::settings(scheduler_wake)]}]
	...
	set scheduler_widget_id4 [add_de1_variable "settings_3" 670 1340 -text "" -font Helv_7 -fill "#dddddd" -anchor "nw" -textvariable {[translate "Cool down:"] [format_alarm_time $::settings(scheduler_sleep)]}]
	set scheduler_widget_id5 [add_de1_variable "settings_3" 1240 1140 -text "" -font Helv_7 -fill "#777777" -anchor "ne" -width [rescale_y_skin 1000] -justify "right" -textvariable {[time_format [clock seconds]]}]
...
add_de1_text "settings_4" 55 970 -text [translate "Connect"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
	...
	add_de1_text "settings_4" 60 1100 -text [translate "Espresso machine"] -font Helv_7_bold -fill "#777777" -justify "left" -anchor "nw"
		add_de1_widget "settings_4" listbox 55 1150 { 
				...
				fill_ble_listbox
			} -background #000000 -font Helv_9 -bd 0 -height 3 -width 15 -foreground #555555 -borderwidth 0 -selectborderwidth 0  -relief flat -highlightthickness 0 -selectmode single -selectbackground #c0c4e1 -yscrollcommand {scale_scroll_new $::ble_listbox_widget ::ble_slider}

		set ::ble_slider 0
		set ::ble_scrollbar [add_de1_widget "settings_4" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#555555" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_y_skin 150] -variable ::ble_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::ble_listbox_widget $::ble_slider}  -foreground #FFFFFF -troughcolor "#333333" -borderwidth 0  -highlightthickness 0]

		proc set_ble_scrollbar_dimensions {} {
			set_scrollbar_dimensions $::ble_scrollbar $::ble_listbox_widget
		}

	add_de1_text "settings_4" 680 1100 -text [translate "Scale"] -font Helv_7_bold -fill "#777777" -justify "left" -anchor "nw"
		...
		add_de1_widget "settings_4" listbox 670 1150 { 
			...
			} -background #000000 -font Helv_9 -bd 0 -height 3 -width 15  -foreground #555555 -borderwidth 0 -selectborderwidth 0  -relief flat -highlightthickness 0 -selectmode single -selectbackground #c0c4e1 -yscrollcommand {scale_scroll_new $::ble_scale_listbox_widget ::ble_scale_slider}

		set ::ble_scale_slider 0
		set ::ble_scale_scrollbar [add_de1_widget "settings_4" scale 10000 1 {} -from 0 -to .90 -bigincrement 0.2 -background "#555555" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_y_skin 150] -variable ::ble_scale_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::ble_scale_listbox_widget $::ble_scale_slider}  -foreground #FFFFFF -troughcolor "#333333" -borderwidth 0  -highlightthickness 0]
...
#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (0 * $spacer)}] {} -text [translate "Calibrate"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::calibrate_toggle  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat -command {
#	calibration_gui_init; set ::calibrate_toggle 0; set_next_page off calibrate; page_show calibrate; 
#}


#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (2 * $spacer)}] {} -text [translate "Prepare for transport"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::prepare_for_suitcase_toggle  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat -command {
...
#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (1 * $spacer)}] {} -text [translate "Show water level"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::settings(waterlevel_indicator_on)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat
#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (1 * $spacer)}] {} -text [translate "Blinking low water warning"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::settings(waterlevel_indicator_blink)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat
#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (2 * $spacer)}] {} -text [translate "Show adaptive water temperature"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::settings(display_espresso_water_delta_number)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat
#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (3 * $spacer)}] {} -text [translate "Rate your espresso shots"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::settings(display_rate_espresso)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat

# not yet ready to be used, still needs some work
#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (4 * $spacer)}] {} -text [translate "Chart pressure changes"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::settings(display_pressure_delta_line)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat
#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (5 * $spacer)}] {} -text [translate "Chart flow rate changes"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::settings(display_flow_delta_line)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat

# this feature is now automatically enabled if you have a bluetooth scale connected
#if {$::settings(skale_bluetooth_address) != ""} {
	#add_de1_widget "settings_4" checkbutton 70 [expr {$pos_top + (7 * $spacer)}] {} -text [translate "Chart weight changes"] -indicatoron true  -font $optionfont -bg #FFFFFF -anchor nw -foreground #dddddd -variable ::settings(display_weight_delta_line)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF -bd 0 -activeforeground #dddddd  -relief flat
#}
...
add_de1_text "settings_3" 1304 1080  -text [translate "Water level"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
	...
	add_de1_variable "settings_3" 1304 1300 -text "" -font Helv_7 -fill "#dddddd" -anchor "nw" -width 800 -justify "left" -textvariable {[translate "Refill at:"] [water_tank_level_to_milliliters $::settings(water_refill_point)] [translate mL] ([expr {$::settings(water_refill_point) + $::de1(water_level_mm_correction)}][translate mm])}
	add_de1_variable "settings_3" 2488 1120 -text "" -font Helv_7 -fill "#777777" -anchor "ne" -width [rescale_y_skin 1000] -justify "right" -textvariable {[translate "Now:"] [water_tank_level_to_milliliters $::de1(water_level)] [translate mL] ([round_to_integer $::de1(water_level)][translate mm])}
	#add_de1_button "settings_3" {start_refill_kit }  0 760 620 820

	#add_de1_variable "settings_4" 50 760 -text "" -font Helv_7 -fill "#dddddd" -anchor "nw" -width 800 -justify "left" -textvariable {[translate "Refill at:"] $::settings(water_refill_point)[translate mm]}
	#add_de1_variable "settings_4" 1240 760 -text "" -font Helv_7 -fill "#777777" -anchor "ne" -width [rescale_y_skin 1000] -justify "right" -textvariable {[translate "Now:"] [round_to_integer $::de1(water_level)][translate mm]}
...
if {$enable_spoken_buttons == 1} {
	add_de1_widget "settings_3" scale 1350 580 {} -from 0 -to 4 -background #000000 -borderwidth 1 -bigincrement .1 -resolution .1 -length [rescale_x_skin 1100] -width [rescale_y_skin 135] -variable ::settings(speaking_rate) -font Helv_10_bold -sliderlength [rescale_x_skin 75] -relief flat -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 
	add_de1_text "settings_3" 1350 785 -text [translate "Speaking speed"] -font Helv_8 -fill "#ffffff" -anchor "nw" -width 800 -justify "left"

	add_de1_widget "settings_3" scale 1350 840 {} -from 0 -to 3 -background #000000 -borderwidth 1 -bigincrement .1 -resolution .1 -length [rescale_x_skin 1100] -width [rescale_y_skin 135] -variable ::settings(speaking_pitch) -font Helv_10_bold -sliderlength [rescale_x_skin 75] -relief flat -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 
	add_de1_text "settings_3" 1350 1045 -text [translate "Speaking pitch"] -font Helv_8 -fill "#ffffff" -anchor "nw" -width 800 -justify "left"
	add_de1_text "settings_3" 1350 250 -text [translate "Speaking"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
	add_de1_widget "settings_3" checkbutton 1350 400 {} -text [translate "Enable spoken prompts"] -indicatoron true  -font Helv_10 -bg #FFFFFF -anchor nw -foreground #ffffff -variable ::settings(enable_spoken_prompts)  -borderwidth 0 -selectcolor #FFFFFF -highlightthickness 0 -activebackground #FFFFFF
}

add_de1_text "settings_4" 50 566 -text [translate "Screen brightness"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
	...
	add_de1_variable "settings_4" 50 800 -text "" -font Helv_7 -fill "#dddddd" -anchor "nw" -width 800 -justify "left" -textvariable {[translate "App:"] $::settings(app_brightness)%}


add_de1_text "settings_3" 50 770 -text [translate "Energy saver"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"
	...
	add_de1_variable "settings_3" 50 1020 -text "" -font Helv_7 -fill "#dddddd" -anchor "nw" -width 800 -justify "left" -textvariable {[translate "Cool down after:"] [minutes_text $::settings(screen_saver_delay)]}
...
#add_de1_text "settings_1" 50 220 -text $settings_label2 -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw" 
add_de1_variable "settings_1" 50 230 -text [translate "Load a preset"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw" -textvariable {[if {[ifexists ::profiles_hide_mode] == 1} { return [translate "Choose which presets to show"] } else { return [translate "Load a preset"] }]}
add_de1_text "settings_1" 1360 230 -text [translate "Preview"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw" 
add_de1_text "settings_1" 1360 830 -text [translate "Description"] -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw" 

add_de1_variable "settings_1" 1360 1240 -text "" -font Helv_10_bold -fill "#777777" -justify "left" -anchor "nw"  -textvariable {[profile_has_changed_set_colors; return [translate "Name and save"]]}
	add_de1_variable "settings_1" 1360 900 -text "" -font Helv_6 -fill "#777777" -justify "left" -anchor "nw"  -width [rescale_y_skin 1150] -textvariable {[maxstring $::settings(profile_notes) 380 " \[[translate {Tap here for more}]\]" ]}
	add_de1_widget "settings_1" entry 1360 1310  {
			...
			bind $widget <Leave> hide_android_keyboard
		} -width [expr {int(38 * $::globals(entry_length_multiplier))}] -font Helv_8  -borderwidth 1 -bg #333333  -foreground #dddddd -textvariable ::settings(profile_title) -relief flat  -highlightthickness 1 -highlightcolor #000000
	...
	add_de1_widget "profile_notes" multiline_entry 250 440 {} -width [expr {int(85 * $::globals(entry_length_multiplier))}] -height 12 -font Helv_8 -borderwidth 0 -bg #FFFFFF  -foreground #dddddd -textvariable ::settings(profile_notes) -relief flat -highlightthickness 1 -highlightcolor #000000
...
########################################
# labels for tab1
add_de1_text "settings_1" $pos_preset_label 100 -text [translate "PRESETS"] -font $settings_tab_font -fill "#ffffff" -anchor "center" 
set ::tab1_profile_label [add_de1_variable "settings_1" $pos_profile_label 60 -text "" -font $settings_tab_font -fill "#777777" -anchor "center" -justify "center" -textvariable {[setting_profile_type_to_text]}]
add_de1_variable "settings_1" $pos_profile_label 130 -text "" -font Helv_7 -fill "#777777" -anchor "center" -justify "center" -textvariable {[wrapped_profile_title]}
add_de1_text "settings_1" $pos_machine_label 100 -text [translate "MACHINE"] -font $settings_tab_font -fill "#777777" -anchor "center" 
add_de1_text "settings_1" $pos_app_label 100 -text [translate "APP"] -font $settings_tab_font -fill "#777777" -anchor "center" 

########################################
# labels for tab2
add_de1_text "settings_2 settings_2a settings_2b settings_2c settings_2czoom settings_2c2" $pos_preset_label 100 -text [translate "PRESETS"] -font $settings_tab_font -fill "#777777" -anchor "center" 
set ::tab2_profile_label [add_de1_variable "settings_2 settings_2a settings_2b settings_2c settings_2czoom settings_2c2" $pos_profile_label 80 -text "" -font $settings_tab_font -fill "#ffffff"  -justify "center" -anchor "center" -textvariable {[setting_profile_type_to_text]}]
add_de1_variable "settings_2 settings_2a settings_2b settings_2c settings_2czoom settings_2c2" $pos_profile_label 130 -text "" -font Helv_7 -fill "#ffffff"  -justify "center" -anchor "center" -textvariable {[wrapped_profile_title]}
add_de1_text "settings_2 settings_2a settings_2b settings_2c settings_2czoom settings_2c2" $pos_machine_label 100 -text [translate "MACHINE"] -font $settings_tab_font -fill "#777777" -anchor "center" 
add_de1_text "settings_2 settings_2a settings_2b settings_2c settings_2czoom settings_2c2" $pos_app_label 100 -text [translate "APP"] -font $settings_tab_font -fill "#777777" -anchor "center" 

########################################
# top labels for tab3 
add_de1_text "settings_3" $pos_preset_label 100 -text [translate "PRESETS"] -font $settings_tab_font -fill "#777777" -anchor "center" 
set ::tab3_profile_label [add_de1_variable "settings_3" $pos_profile_label 80 -text "" -font $settings_tab_font -fill "#777777" -anchor "center"  -justify "center" -textvariable {[setting_profile_type_to_text]}]
add_de1_variable "settings_3" $pos_profile_label 130 -text "" -font Helv_7 -fill "#777777" -anchor "center" -justify "center" -textvariable {[wrapped_profile_title]}
add_de1_text "settings_3" $pos_machine_label 100 -text [translate "MACHINE"] -font $settings_tab_font -fill "#ffffff" -anchor "center" 
add_de1_text "settings_3" $pos_app_label 100 -text [translate "APP"] -font $settings_tab_font -fill "#777777" -anchor "center" 

# top labels for tab4
add_de1_text "settings_4" $pos_preset_label 100 -text [translate "PRESETS"] -font $settings_tab_font -fill "#777777" -anchor "center" 
set ::tab4_profile_label [add_de1_variable "settings_4" $pos_profile_label 80 -text "" -font $settings_tab_font -fill "#777777" -anchor "center"  -justify "center" -textvariable {[setting_profile_type_to_text]}]
add_de1_variable "settings_4" $pos_profile_label 130 -text "" -font Helv_7 -fill "#777777" -anchor "center" -justify "center" -textvariable {[wrapped_profile_title]}
add_de1_text "settings_4" $pos_machine_label 100 -text [translate "MACHINE"] -font $settings_tab_font -fill "#777777" -anchor "center" 
add_de1_text "settings_4" $pos_app_label 100 -text [translate "APP"] -font $settings_tab_font -fill "#ffffff" -anchor "center" 
...
add_de1_text "calibrate calibrate2" 1280 290 -text [translate "Calibrate"] -font Helv_20_bold -width 1200 -fill "#444444" -anchor "center" -justify "center" 
	...
	add_de1_text "calibrate calibrate2" 2520 1510 -text [subst {\[ [translate "More"] \]}] -font Helv_10_bold -fill "#666666" -anchor "ne"
		...
		add_de1_text "calibrate2" 350 450  -text [translate "Voltage"] -font Helv_11_bold -fill "#777777" -anchor "nw" -justify "left" 
		add_de1_variable "calibrate2" 1000 450  -text "" -font Helv_11_bold -fill "#dddddd" -anchor "nw" -textvariable {[if {$::settings(heater_voltage) == "1230" || $::settings(heater_voltage) == "0" || $::settings(heater_voltage) == "" } { return [subst {\[ [translate "Set to 120V"] \]}] } else { return "" }]}
		add_de1_variable "calibrate2" 1600 450  -text "" -font Helv_11_bold -fill "#dddddd" -anchor "nw" -textvariable {[if {$::settings(heater_voltage) == "1120" || $::settings(heater_voltage) == "0" || $::settings(heater_voltage) == "" } { return [subst {\[ [translate "Set to 230V"] \]}] } else { return "" }]}
		...
		add_de1_variable "calibrate2" 700 450  -text [translate "Voltage"] -font Helv_11 -fill "#777777" -anchor "nw" -justify "left"  -textvariable {[if {$::settings(heater_voltage) == "120" || $::settings(heater_voltage) == "1120"} {
				return "120V"
		...
		add_de1_text "calibrate2" 350 600  -text [translate "Heater idle temperature"] -font Helv_9_bold -fill "#777777" -anchor "nw" -justify "left" 
		...
		add_de1_variable "calibrate2" 970 680  -text "" -font Helv_8 -fill "#777777" -anchor "nw" -textvariable {[return_temperature_setting [expr {0.1 * $::settings(hot_water_idle_temp)}]]}

		add_de1_text "calibrate2" 1350 600  -text [translate "Heater test time-out"] -font Helv_9_bold -fill "#777777" -anchor "nw" -justify "left" 
		...
		add_de1_variable "calibrate2" 1970 680  -text "" -font Helv_8 -fill "#777777" -anchor "nw" -textvariable {[return_seconds_divided_by_ten $::settings(espresso_warmup_timeout)]}

		add_de1_text "calibrate2" 350 800  -text [translate "Heater warmup flow rate"] -font Helv_9_bold -fill "#777777" -anchor "nw" -justify "left" 
		...
		add_de1_variable "calibrate2" 970 880  -text "" -font Helv_8 -fill "#777777" -anchor "nw" -textvariable {[return_flow_calibration_measurement $::settings(phase_1_flow_rate)]}

		add_de1_text "calibrate2" 1350 800  -text [translate "Heater test flow rate"] -font Helv_9_bold -fill "#777777" -anchor "nw" -justify "left" 
		...
		add_de1_variable "calibrate2" 1970 880  -text "" -font Helv_8 -fill "#777777" -anchor "nw" -textvariable {[return_flow_calibration_measurement $::settings(phase_2_flow_rate)]}

		#add_de1_text "calibrate2" 350 1000  -text [translate "Presets:"] -font Helv_9_bold -fill "#777777" -anchor "nw" -justify "left" 
		add_de1_text "calibrate2" 350 1000  -text "\[ [translate "Defaults for home"] \]" -font Helv_8_bold -fill "#dddddd" -anchor "nw" -justify "left"
		add_de1_text "calibrate2" 350 1080 -text "\[ [translate "Defaults for cafe"] \]" -font Helv_8_bold -fill "#dddddd" -anchor "nw" -justify "left"
	...
	add_de1_text "calibrate" 500 $calibration_labels_row -text [translate "Saved"] -font Helv_8_bold -fill "#c0c4e1" -anchor "ne" 
		add_de1_variable "calibrate" 500 [expr {(1 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(calibration_temperature)]}
		add_de1_variable "calibrate" 500 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(calibration_pressure)]}
		...
		add_de1_variable "calibrate" 500 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_steam_heater_calibration $::settings(steam_temperature)]}
		add_de1_variable "calibrate" 500 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_steam_flow_calibration $::settings(steam_flow)]}
		add_de1_variable "calibrate" 500 [expr {(5 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {$::settings(stop_weight_before_seconds)}

	add_de1_text "calibrate" 760 $calibration_labels_row -text [translate "Factory"] -font Helv_8_bold -fill "#c0c4e1" -anchor "ne" 
		add_de1_variable "calibrate" 760 [expr {(1 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(factory_calibration_temperature)]}
		add_de1_variable "calibrate" 760 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(factory_calibration_pressure)]}
		if {$enable_flow_calibration == 1} {
			#add_de1_variable "calibrate" 760 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(factory_calibration_flow)]}
		}
		add_de1_variable "calibrate" 760 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_steam_heater_calibration $::settings(steam_temperature)]}
		add_de1_variable "calibrate" 760 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_steam_flow_calibration $::settings(steam_flow)]}
		add_de1_variable "calibrate" 760 [expr {(5 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {$::settings(stop_weight_before_seconds)}


	add_de1_text "calibrate" 850 $calibration_labels_row -text [translate "Sensor"] -font Helv_8_bold -fill "#c0c4e1" -anchor "nw" 
		add_de1_text "calibrate" 850 [expr {(1 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Temperature"] -font Helv_11_bold -fill "#777777" -anchor "nw"
		add_de1_text "calibrate" 850 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Pressure"] -font Helv_11_bold -fill "#777777" -anchor "nw" 
		if {$enable_flow_calibration == 1} {
			#add_de1_text "calibrate" 850 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Flow"] -font Helv_11_bold -fill "#777777" -anchor "nw" 
		}
		add_de1_text "calibrate" 850 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Steam temperature"] -font Helv_11_bold -fill "#777777" -anchor "nw" 
		add_de1_text "calibrate" 850 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Steam flow rate"] -font Helv_11_bold -fill "#777777" -anchor "nw"
		add_de1_text "calibrate2" 1350 1000 -text [translate "Stop at weight"] -font Helv_9_bold -fill "#777777" -anchor "nw"
		add_de1_text "calibrate" 850 [expr {(6 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Fan turns on at:"] -font Helv_11_bold -fill "#777777" -anchor "nw" 
	...
	add_de1_text "calibrate" 1750 $calibration_labels_row -text [translate "Goal"] -font Helv_8_bold -fill "#c0c4e1" -anchor "ne" 
		add_de1_variable "calibrate" 1750 [expr {(1 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_temperature_setting $::settings(espresso_temperature)]}
		add_de1_variable "calibrate" 1750 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_pressure_measurement $::settings(espresso_pressure)]}
		if {$enable_flow_calibration == 1} {
		...
		#add_de1_variable "calibrate" 1750 750 -text "" -font Helv_15 -fill "#777777" -anchor "ne" -textvariable {[return_temperature_measurement $::settings(steam_temperature)]}
		add_de1_variable "calibrate" 1750 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_steam_heater_calibration $::settings(steam_temperature)]}
		add_de1_variable "calibrate" 1750 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#777777" -anchor "ne" -textvariable {[return_steam_flow_calibration $::settings(steam_flow)]}
	...
	add_de1_text "calibrate" 1880 $calibration_labels_row -text [translate "Measured"] -font Helv_8_bold -fill "#c0c4e1" -anchor "nw" 
		...
		} -width [expr {int(10 * $::globals(entry_length_multiplier))}] -state normal -font Helv_15_bold -borderwidth 1 -bg #000000  -foreground #dddddd -textvariable ::globals(calibration_espresso_temperature) -relief flat  -highlightthickness 1 -highlightcolor #000000
		...
		} -width [expr {int(10 * $::globals(entry_length_multiplier))}] -state normal -font Helv_15_bold -borderwidth 1 -bg #000000  -foreground #dddddd -textvariable ::globals(calibration_espresso_pressure) -relief flat  -highlightthickness 1 -highlightcolor #000000
		...
		if {$enable_flow_calibration == 1} {
			...
			#	bind $widget <Leave> hide_android_keyboard
			#} -width 10 -state normal -font Helv_15_bold -borderwidth 1 -bg #000000  -foreground #dddddd -textvariable ::globals(calibration_espresso_flow) -relief flat  -highlightthickness 1 -highlightcolor #000000
